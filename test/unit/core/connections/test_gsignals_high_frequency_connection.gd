...
func test_can_start_connection() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_0_args, [], signal_counter.callback_0_args, 0)
    connection.start()
...
func test_can_handle_signal_with_1_arg() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_1_arg, [], signal_counter.callback_1_arg, 0)
    connection.start()
...
func test_can_handle_signal_with_2_args() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_2_args, [], signal_counter.callback_2_args, 0)
    connection.start()
...
func test_can_handle_signal_with_3_args() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_3_args, [], signal_counter.callback_3_args, 0)
    connection.start()
...
func test_can_handle_signal_with_4_args() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_4_args, [], signal_counter.callback_4_args, 0)
    connection.start()
...
func test_can_handle_signal_with_5_args() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_5_args, [], signal_counter.callback_5_args, 0)
    connection.start()
...
func test_can_handle_signal_with_6_args() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_6_args, [], signal_counter.callback_6_args, 0)
    connection.start()
...
func test_can_handle_signal_with_7_args() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_7_args, [], signal_counter.callback_7_args, 0)
    connection.start()
...
func test_can_handle_signal_with_8_args() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_8_args, [], signal_counter.callback_8_args, 0)
    connection.start()
...
func test_can_handle_signal_with_9_args() -> void:
    var connection: GSignalsHighFrequencyConnection = GSignalsHighFrequencyConnection.new(signal_counter.signal_9_args, [], signal_counter.callback_9_args, 0)
    connection.start()
